...
public static class Effects
{
    ...
    {
        public static void Initialize(Transform cameraTransform) 
            => CameraEffectManager.Initialize(cameraTransform);

        public static void Shake(float duration = 0.3f, float strength = 0.3f) 
            => CameraEffectManager.Shake(duration, strength);
    }
...
public static class CameraEffectManager
{
    ...
    public static void Shake(float duration = 0.3f, float strength = 0.3f)
    {
        ...
        _cameraTransform.DOShakePosition(duration, strength, 10, 90, true);
    }
}
